...
advancing; `blocked_on_decision`, `runner_error`, and owner-judgment findings
escalate. Store mutations are serialized across CLI and daemon processes.
Dry-run formation executes one simulated task to terminal state and suppresses
