...
pub(super) use agent_helpers::{
    ...
    invoke_summary_agent, json_output_prompt, match_agent_text_outcome, parse_agent_json,
...
pub(super) use event_builders::{
    ...
    event_from_payload, execution_completed_event, format_gates_context, single_event_result,
};
...
mod check_charter;
mod check_pipeline;
mod classify_dependency_updates;
mod cleanup_branches;
mod complete_project_run;
mod create_plan;
mod direct_prompt;
mod dispose_campaign_work;
...
pub use classify_dependency_updates::ClassifyDependencyUpdates;
...
pub use dispose_campaign_work::DisposeCampaignWork;
...
pub use plan_major_upgrades::PlanMajorUpgrades;
