...
- Maintenance summary now correctly classifies retry-recovered iterations as Success when the terminal `ProjectIterationCompleted` event reports `success=true`, even when earlier block executions failed.
